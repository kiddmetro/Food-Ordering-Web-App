                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    {
                                        foreach($query_run as $vegan)
                                        {
                                            ?>
                                            <tr>
                                                <td><?= $vegan['vegan_id']; ?></td>
                                                <td><?= $vegan['image']; ?></td>
                                                <td><?= $vegan['vegan_category']; ?></td>
                                                <td><?= $vegan['vegan_title']; ?></td>
                                                <td><?= $vegan['vegan_price']; ?></td>
                                                <td><?= $vegan['vegan_time']; ?></td>
                                                <td><?= $vegan['vegan_desc']; ?></td>

                                                <td>
                                                    <a href="vegan-edit.php?vegan_id=<?= $vegan['vegan_id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="backcode.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_vegan" value="<?=$vegan['vegan_id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
