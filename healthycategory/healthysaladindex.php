                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    {
                                        foreach($query_run as $salad)
                                        {
                                            ?>
                                            <tr>
                                                <td><?= $salad['salad_id']; ?></td>
                                                <td><?= $salad['image']; ?></td>
                                                <td><?= $salad['salad_category']; ?></td>
                                                <td><?= $salad['salad_title']; ?></td>
                                                <td><?= $salad['salad_price']; ?></td>
                                                <td><?= $salad['salad_time']; ?></td>
                                                <td><?= $salad['salad_desc']; ?></td>

                                                <td>
                                                    <a href="salad-edit.php?salad_id=<?= $salad['salad_id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="backcode.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_salad" value="<?=$salad['salad_id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
